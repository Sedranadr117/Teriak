...
import 'package:teriak/features/product_details/presentation/pages/product_details/subWidget/barcodes_widget.dart';
import 'package:teriak/features/product_details/presentation/pages/product_details/subWidget/info_details_card_widget.dart'
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Builder(
          builder: (context) {
            final bool isPharmacy = (widget.drugData.productType == "Pharmacy") ||(widget.drugData.productType == "صيدلية");
