...
import 'package:teriak/features/product_data/data/datasources/product_data_remote_data_source.dart';
import 'package:teriak/features/product_data/data/repositories/product_data_repository_impl.dart';
import 'package:teriak/features/product_data/domain/usecases/get_product_data.dart';
...
class ProductDataController extends GetxController {
  ...
  Future<void> getProductData(String type) async {
    try {
      ...
      final result = await getProductDataUseCase(params:params);
      result.fold(
