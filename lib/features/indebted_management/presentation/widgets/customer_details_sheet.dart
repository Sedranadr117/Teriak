...
class CustomerDetailsSheet extends StatelessWidget {
  ...
  final VoidCallback onSetPaymentPlan;
  ...
  const CustomerDetailsSheet({
    ...
    required this.onSetPaymentPlan,
  });
                  ...
                  _buildDetailSection(
                    ...
                    [
                      ...
                      _buildDetailRow('Email',
                          customer['email']?.toString() ?? 'Not provided'),
                      _buildDetailRow('Address',
                          customer['address']?.toString() ?? 'Not provided'),
                    ],
                  ),
