...
import 'package:teriak/features/purchase_order/search_purchase_order/domain/usecases/get_search_purchase_order.dart';
...
import 'package:teriak/features/purchase_order/search_purchase_order/data/datasources/search_purchase_order_remote_data_source.dart';
import 'package:teriak/features/purchase_order/search_purchase_order/data/repositories/search_purchase_order_repository_impl.dart';

class SearchPurchaseOrderController extends GetxController {
  ...
  // Use cases
  late final GetSearchPurchaseOrder searchBySupplierUseCase;
  late final GetSearchPurchaseOrder searchByDateRangeUseCase;
  ...
  void _initializeDependencies() {
    ...
    final repository = SearchPurchaseOrderRepositoryImpl(
      remoteDataSource: remoteDataSource,
      networkInfo: networkInfo,
    );

    searchBySupplierUseCase = GetSearchPurchaseOrder(repository: repository);
    searchByDateRangeUseCase = GetSearchPurchaseOrder(repository: repository);
  }
